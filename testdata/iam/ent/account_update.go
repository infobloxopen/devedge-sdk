...
func (_u *AccountUpdate) SetEtag(v string) *AccountUpdate {
	_u.mutation.SetEtag(v)
	return _u
}

// SetNillableEtag sets the "etag" field if the given value is not nil.
func (_u *AccountUpdate) SetNillableEtag(v *string) *AccountUpdate {
	if v != nil {
		_u.SetEtag(*v)
	}
	return _u
...
func (_u *AccountUpdate) ClearEtag() *AccountUpdate {
...
func (_u *AccountUpdate) ClearDisplayName() *AccountUpdate {
...
func (_u *AccountUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.EtagCleared() {
		_spec.ClearField(account.FieldEtag, field.TypeString)
	}
	if value, ok := _u.mutation.DisplayName(); ok {
		_spec.SetField(account.FieldDisplayName, field.TypeString, value)
	}
	if _u.mutation.DisplayNameCleared() {
		_spec.ClearField(account.FieldDisplayName, field.TypeString)
	}
...
// SetEtag sets the "etag" field.
func (_u *AccountUpdateOne) SetEtag(v string) *AccountUpdateOne {
	_u.mutation.SetEtag(v)
	return _u
}

// SetNillableEtag sets the "etag" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillableEtag(v *string) *AccountUpdateOne {
	if v != nil {
		_u.SetEtag(*v)
	}
	return _u
...
// ClearEtag clears the value of the "etag" field.
func (_u *AccountUpdateOne) ClearEtag() *AccountUpdateOne {
	_u.mutation.ClearEtag()
	return _u
}
...
// ClearDisplayName clears the value of the "display_name" field.
func (_u *AccountUpdateOne) ClearDisplayName() *AccountUpdateOne {
	_u.mutation.ClearDisplayName()
	return _u
}
