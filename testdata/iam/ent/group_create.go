...
func (_c *GroupCreate) SetAccountID(v string) *GroupCreate {
	_c.mutation.SetAccountID(v)
	return _c
}

// SetEtag sets the "etag" field.
func (_c *GroupCreate) SetEtag(v string) *GroupCreate {
	_c.mutation.SetEtag(v)
	return _c
}

// SetNillableEtag sets the "etag" field if the given value is not nil.
func (_c *GroupCreate) SetNillableEtag(v *string) *GroupCreate {
	if v != nil {
		_c.SetEtag(*v)
	}
	return _c
...
func (_c *GroupCreate) AddMemberships(v ...*Membership) *GroupCreate {
...
func (_c *GroupCreate) check() error {
	...
	if v, ok := _c.mutation.AccountID(); ok {
		if err := group.AccountIDValidator(v); err != nil {
			return &ValidationError{Name: "account_id", err: fmt.Errorf(`ent: validator failed for field "Group.account_id": %w`, err)}
		}
	}
	return nil
}
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AccountID(); ok {
		_spec.SetField(group.FieldAccountID, field.TypeString, value)
