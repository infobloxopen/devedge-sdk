...
// gorm_sqlite_test.go — a self-contained GORM SQLite dialector for the
// federation GORM tests, mirroring the inline dialector the fleet/apikey
// fixtures use. We cannot
