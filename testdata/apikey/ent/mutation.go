...
// ClearLabel clears the value of the "label" field.
func (m *TokenMutation) ClearLabel() {
	m.label = nil
	m.clearedFields[token.FieldLabel] = struct{}{}
}

// LabelCleared returns if the "label" field was cleared in this mutation.
func (m *TokenMutation) LabelCleared() bool {
	_, ok := m.clearedFields[token.FieldLabel]
	return ok
}
...
func (m *TokenMutation) ResetLabel() {
	m.label = nil
	delete(m.clearedFields, token.FieldLabel)
}
...
func (m *TokenMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(token.FieldLabel) {
		fields = append(fields, token.FieldLabel)
	}
	return fields
}
