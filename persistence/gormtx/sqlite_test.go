...
// sqlite_test.go — a self-contained GORM SQLite dialector for the gormtx unit
// tests. It mirrors the inline dialector the GORM fixtures use (testdata/apikey
// .../security_isolation_test.go): we cannot import gorm.io/driver/sqlite (it
// blank-imports the CGo mattn driver), so this uses only gorm.io/gorm
// sub-packages plus the modernc.org/sqlite driver, registered under "sqlite3".
